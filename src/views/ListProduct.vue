                ...
                <tr v-for="person in people" :key="person.id">
                  ...
                  <td>
                    <div class="mx-4 space-x-3">
                      <button @click="openEditModal(person, true)" class="text-indigo-600 hover:text-indigo-900">
                ...
                <Combobox as="div" v-model="categoryProduct">
                  ...
                  <div class="relative mt-1">
                    ...
                    <ComboboxOptions v-if="filteredProduct.length > 0"
                      ...
                      <ComboboxOption v-for="product in filteredProduct" :key="product.id" :value="product" as="template"
              ...
              <div class="sm:col-span-full mt-4">
                <div class="overflow-x-auto mb-4">
                  <table class="min-w-full bg-white border border-gray-300 rounded-md">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in items" :key="index" class="hover:bg-gray-100 transition">
                        <td class="py-2 px-4 border-b">
                          <div class="relative">
                            <select v-model="item.size" @change="ChooseCombobox(false, index, $event.target.value)"
                              class="block appearance-none w-full bg-white border border-gray-300
                                                                                                 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:ring-2 
                                                                                                 focus:ring-inset focus:ring-indigo-600">
                              <option v-for="(size, sizeIndex) in sizeOptions" :key="sizeIndex" :value="size">
                                {{ size }}
                              </option>
                            </select>
                            <div
                        ...
                        <td class="py-2 px-4 border-b">
                          <div class="relative">
                            <select v-model="item.color" @change="ChooseCombobox(true, index, $event.target.value)"
                              ...
                              <option v-for="(color, colorIndex) in colorOptions" :key="colorIndex" :value="color">
                                {{ color }}
                              </option>
                            </select>
                            <div
                        ...
                        <td class="py-2 px-4 border-b">
                          <input type="number" v-model="item.quantity" @input="validateQuantity(index)"
                ...
                <div class="container mx-auto">
                  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative">
                      ...
                      <span class="absolute inset-y-0 right-0 flex items-center pr-2 text-gray-500">cm</span>
                    </div>
