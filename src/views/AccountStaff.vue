          ...
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                ...
                <th
                  scope="col"
                  class="px-3.5 py-3.5 text-left text-sm font-semibold text-gray-900"
                >
                  Chức vụ cao nhất
                </th>
  ...
  <div v-show="isOpenModal">
    ...
    >
      <div class="flex items-center justify-center min-h-screen">
        ...
        ></div>
        <div
          class="relative bg-white p-6 rounded-lg max-w-5xl max-h-[600px] overflow-y-auto overflow-hidden"
        >
          ...
          <form
            ...
            class="mx-auto mt-8 sm:max-w-xl sm:mt-7"
          >
                    ...
                    >
                      <span class="flex flex-grow flex-col">
                        <SwitchDescription
                          ...
                          >Shiper</SwitchDescription
                        >
                      </span>
                      <Switch
                        v-model="staffEdit.isShiper"
                        :class="[
                    ...
                    >
                      <span class="flex flex-grow flex-col">
                        <SwitchDescription
                          as="span"
                          class="text-sm text-gray-500"
                          >Staff</SwitchDescription
                        >
                      </span>
                      <Switch
                        v-model="staffEdit.isStaff"
                        :class="[
        ...
        >
          ...
          >
            ...
            >
              <div
                v-if="showError"
                class="ml-4 p-2 bg-red-100 text-red-500 text-sm rounded"
              >
