    ...
    <div class="lg:pl-72">
      ...
      >
        ...
        <ol
          ...
          v-if="store.currentPage.index >= 0"
        >
          <li>
            <div>
              <span class="text-gray-400 hover:text-gray-500">
                <span
                  v-if="
                    ...
                    store.currentPage.index != 99
                  "
                >
                  <component
                    :is="navigation[store.currentPage.index].icon"
                    class="h-5 w-5 flex-shrink-0"
                    aria-hidden="true"
                  />
                  <span class="sr-only">{{
                    navigation[store.currentPage.index].name
                  }}</span>
                </span>
                <span v-else-if="store.currentPage.index == 99">
                  <component
                    :is="userEditNavi.icon"
                    class="h-5 w-5 flex-shrink-0"
                    aria-hidden="true"
                  />
          ...
          <li
            v-if="
              store.currentPage.index != -1 &&
              store.currentPage.index != 99 &&
              navigation[store.currentPage.index].children &&
              store.currentPage.child != -1
            "
          >
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              ...
              >
                ...
                />
                <span
                  class="hidden lg:flex lg:items-center ml-4 text-sm font-semibold leading-6 text-gray-900"
                >
                  {{ store.fullName }}
                </span>
              </MenuButton>
...
const navigation = ref([
  { name: "Trang chủ", href: "/admin/home", icon: HomeIcon, current: true },
  {
    ...
    current: false,
    children: [
      { name: "Danh sách khách hàng", href: "/admin/user", current: false },
    ],
  },
  {
    ...
    if (newValue.index != -1 && newValue.index != 99) {
      try {
        ...
        if (navigation.value[newValue.index].children && newValue.child != -1) {
          try {
            navigation.value[newValue.index].children[
              newValue.child
            ].current = true;
          } catch (error) {
            console.error(error);
